...
RUN apt-get update && \
  apt-get -y install git apache2 php5-cli php5-mysql php5-gd php5-curl php5-sqlite libapache2-mod-php5 curl mysql-server mysql-client phpmyadmin wget unzip cron supervisor && \
...
RUN cd /var/www && drupal site:new html 8.1.8
